...
export function ChallengeNavigationTabs({ slug, children }: ChallengeNavigationTabsProps) {
  ...
  return (
    <Tabs ref={tabsRef} className="flex h-full w-full flex-col overflow-hidden" value={selectedTab}>
      <TabsList
        className={cn(
      ...
      <TabsContent className="mt-0 h-[calc(100%_-_44px)]" value={selectedTab} ref={tabsContentRef}>
        {children}
      </TabsContent>
    </Tabs>
  );
