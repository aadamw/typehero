...
} from '../_components/challenge-layout';
import { MOBILE_BREAKPOINT } from './challenge-layout';
import usePanelAdjustments from '../_components/usePanelAdjustments';

export function useLayoutPanelsResize({ isPlayground }: { isPlayground?: boolean }) {
  //TODO
  const [isDesktop, setIsDesktop] = useState(MOBILE_BREAKPOINT < 0);
